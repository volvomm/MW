...
public class ConditionalItemUseInteractable : MonoBehaviour, IInteractable, IIventoryItemRecivers
{
    ...
    [Header("Result")]
    [SerializeField] private bool disableObjectAfterSuccess = false;
    ...
    private void NextLine()
    {
        ...
        else
        {
            ...
            if (setFlagAfterDialogue &&
                !string.IsNullOrEmpty(pendingFlagName) &&
                PuzzleFlagManager.Instance != null)
            {
                PuzzleFlagManager.Instance.SetFlag(pendingFlagName, true);
            }
